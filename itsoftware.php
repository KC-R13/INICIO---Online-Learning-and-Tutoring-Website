...
<section class="courses">
   ...
   <h1 class="heading">IT & Software</h1>
...
<!-- 07  -->
    ...
    <div class="box">
        ...
        <h3>C</h3>
        <div>
            <p>Ultimate Python Workshop 3.0</p>
        ...
        <img src="images/code.jpg" alt="">
            ...
            <div class="flex">
            <p><i class="fas fa-clock"></i><span>32 hours</span></p>
            <p><i class="fas fa-money-bill"></i><span>77$</span></p>
            </div>
        <a href="view_course7.php" class="btn">Preview Course</a>
        </div>
        <br> <br>
    </div>
</section>
